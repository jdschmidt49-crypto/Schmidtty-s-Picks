...
#  When running via GitHub Actions, credentials
#  are read automatically from your repo Secrets.
# ─────────────────────────────────────────────
...
# Recipients
RECIPIENT_EMAILS = [
    "j.d.schmidt49@gmail.com",
    "Dan.Audette.2@gmail.com",
    "aaronanderson791@gmail.com",
]

# Sender — the Gmail address this script sends FROM
# For SendGrid/SES, see send_email() below
SENDER_EMAIL = os.environ.get("SENDER_EMAIL", "your.gmail@gmail.com")
...
EMAIL_SUBJECT_PREFIX = "🏆 Schmidtty's Top Picks of the Day —"

# ─────────────────────────────────────────────
#  SCHEDULE — send at 8:00 AM CST daily
#
#  Mac/Linux cron (run: crontab -e, then add):
#    0 8 * * * /usr/bin/python3 /path/to/sports_picks_emailer.py
#  (cron uses your system timezone — make sure it's set to CST/America/Chicago)
#
#  Windows Task Scheduler:
#    Trigger: Daily at 8:00 AM
#    Action:  python C:\path\to\sports_picks_emailer.py
#
#  GitHub Actions (runs in cloud, free — recommended):
#    See the sports_picks_emailer.yml workflow file included alongside this script.
#    14:00 UTC = 8:00 AM CST (UTC-6) / 9:00 AM CDT (UTC-5 in summer)
#    Adjust to 13:00 UTC during Daylight Saving Time (Mar–Nov).
# ─────────────────────────────────────────────
